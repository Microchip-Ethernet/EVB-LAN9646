...
if [ "$DTB" != "at91-sama7d65_curiosity" ]; then
    cp -p ${BINARIES_DIR}/$DTB.dtb ${BINARIES_DIR}/at91-sama7d65_curiosity.dtb
fi
...
echo "./host/bin/sam-ba -w images -x ${BR2_EXTERNAL_KSZ_PATH}/board/microchip/sama7d65_curiosity/nandflash-dev.qml" > ${BASE_DIR}/flash.sh
